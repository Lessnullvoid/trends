...
unistr = u"Лига чемпионов Эверест Хит Парад Бузова 11 сентября Презентация овердрафт Кобзон Отчий берег Матильда BBC Русская служба Саакашвили"
...
if __name__ == "__main__":
	...
	font = pygame.font.Font("BloggerSans.ttf", 180) #Aqui se ajusta el tamano del font
	text = '[0FF]'
	size = font.size(text)
	c_w = 250, 240, 230
	c_b = 5, 5, 5
